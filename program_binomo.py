...
while(True):
    ...
    # Akses admin
        ...
        list_game_di_toko = tambah_game(list_game_di_toko)
    # Akses admin
    elif perintah == "ubah_game":
        list_game_di_toko = ubah_game(list_game_di_toko)
    # Akses admin
    elif perintah == "ubah_stok":
        list_game_di_toko = ubah_stok(list_game_di_toko)
    # Akses user dan admin
    elif perintah == "list_game_toko":
        list_game_toko(list_game_di_toko)
    # Akses user
    elif perintah == "buy_game":
        list_game_dipunya, list_game_di_toko, user_aktif = buy_game(list_game_dipunya, list_game_di_toko, user_aktif)
    ...
    # Akses user dan admin
        ...
        save(list_user, list_game_di_toko, list_game_dipunya, list_riwayat)
    # Akses user dan admin
    elif perintah == "exit":
        exit(list_user, list_game_di_toko, list_game_dipunya, list_riwayat)
